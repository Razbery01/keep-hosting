    ...
    <div className="min-h-[80vh] flex items-center justify-center bg-surface px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-extrabold text-gray-900 tracking-tight">Get Started</h1>
          <p className="text-gray-500 text-sm mt-1">Create your Keep Hosting account</p>
          {preselectedPackage && (
            <span className="inline-block mt-3 bg-accent/10 text-accent px-4 py-1.5 rounded-full text-sm font-semibold capitalize">
